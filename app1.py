...
reset_button = ttk.Button(input_label,text="Reset",padding=(60,20),width=5,style="danger.TButton",command=clear_all)
...
result_label.grid(row=2,column=0,padx=20,pady=10)
...
tuberculosis_meter.grid(row=0,column=2,padx=4,pady=4)
...
normal_meter.grid(row=0,column=3,padx=4,pady=4)
